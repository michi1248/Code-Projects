...
def main(speed=0, bg_color="grey"):
    ...
    # all colors from which to choose random snowflake color
    colors = [(255,255,255),(189,83,168),(83,97,189),(83,168,189),(83,189,168),(94,189,83),(189,147,83)]
    ...
    for _ in range(10):
        ...
        # set random snowflake color
        myTurtle.color(colors[random.randint(0,len(colors)-1)])
